...
[Once it's enabled](https://redis.io/docs/latest/operate/rc/api/get-started/enable-the-api), you can use the REST API to create, update, and delete subscriptions, databases, and other entities.
